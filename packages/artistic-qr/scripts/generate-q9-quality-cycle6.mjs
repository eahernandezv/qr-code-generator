...
const output = resolve(root, 'docs/program/evidence/q9-quality-loop/cycle-6-background-trim-generalization');
...
writeFileSync(resolve(output,'objective-evidence.json'),JSON.stringify({schema_version:'q9-cycle-6-generalization.v1',visual_policy:'q9_negative_space_showcase',payload_sha256:createHash('sha256').update(payload).digest('hex'),targets:evidenceTargets},null,2)+'\n');
