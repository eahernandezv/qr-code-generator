...
const baselinePath = resolve(root, 'docs/program/evidence/q8-quality-loop/cycle-0-baseline/artifacts/image-first.png');
const output = resolve(root, 'docs/program/evidence/q8-quality-loop/cycle-1-protected-island');
...
const options = { _visualPolicy: 'q8_protected_island' };
...
writeFileSync(resolve(output, 'objective-evidence.json'), JSON.stringify({
  schema_version: 'q8-cycle-1-objective.v1', baseline_commit: 'e150965c758ad8ba8b9b407a9e0fab5a100a11e9',
  visual_policy: 'q8_protected_island', reference: { sha256: referenceHash, width: target.width, height: target.height },
