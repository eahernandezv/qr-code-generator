...
const predictionIds=new Set([...live.records.map(x=>x.prediction_id),...failed.records.map(x=>x.prediction_id)].filter(Boolean));
if(live.records.length!==8||successful.length!==4||artifacts.length!==16||predictionIds.size!==9)throw new Error('live counts mismatch');
